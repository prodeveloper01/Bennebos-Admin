                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="form-group mb-2">
                                        <input type="text" name="username" value=""
                                               class="form-control" placeholder="{{ translate('Arslan_username') }}">
                                    </div>
                                    <div class="form-group mb-2">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                ...
                                                <ol class="text-left">
                                                    <li>{{translate('After purchasing Payment & SMS Module from Arslan. You will find a file download option.')}}</li>
