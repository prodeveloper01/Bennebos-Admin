...
@section('content')
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('Provide your') }} <strong>{{ translate('username') }}</strong> {{ translate('of Arslan & the') }} <strong>{{ translate('purchase code') }}</strong> </p>
                                ...
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-html="true"
                                              data-bs-title="The username of your Arslan account">
